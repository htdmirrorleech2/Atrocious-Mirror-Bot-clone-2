...
def start(update, context):
    ...
    buttons.buildbutton("Owner", "https://t.me/howtodoyt")
    buttons.buildbutton("Mirror Leech Group", "https://t.me/htdmirrorleechgp")
    buttons.buildbutton("Tutorial", "https://youtu.be/fuR3k1EkwI4")
